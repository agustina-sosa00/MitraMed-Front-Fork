export default function TermsOfService() {
  return (
    <div className="p-8 max-w-4xl mx-auto text-gray-800">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">1. Uso de la Aplicación</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">2. Recopilación de Datos</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">3. Protección de los Datos</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">6. Cambios en los Términos</h2>
      <p className="mb-4">
