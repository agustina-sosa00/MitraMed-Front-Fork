...
export const SelectBirthdayDiv = ({ field }: Props) => {
  ...
  return (
    <div className="flex justify-between gap-2 lg:gap-4 " onClick={handleCloseSelect}>
      {/* Día */}
      ...
      <div className="relative w-32">
        ...
        >
          {mes ? meses[mes - 1] : <p className="text-sm font-medium text-gray-300">Mes</p>}
          {
            <IoIosArrowDown
              className={`${
                openMes
      ...
      <div className="relative w-32">
        ...
        >
          {anio ? anio : <p className="text-sm font-medium text-gray-300">Año</p>}
          {
            <IoIosArrowDown
              className={`${
                openAnio
