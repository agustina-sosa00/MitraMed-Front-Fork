...
export default function SideBar({ logo, buttons }: IProp) {
  ...
  const adminButtonClass =
    "flex items-center text-start gap-2 pl-2 py-1 w-[90%] text-lg font-medium rounded text-primaryBlue hover:bg-greenHover hover:text-white transition-all duration-300";
        ...
        <div className="flex flex-col items-center w-full gap-3 py-3  h-[20%]">
          ...
          <p className="text-sm">
            ...
            <span
              ...
              className="font-bold transition-all duration-300 cursor-pointer hover:text-primaryGreen"
            >
              Cerrar Sesión
            </span>
            ?
